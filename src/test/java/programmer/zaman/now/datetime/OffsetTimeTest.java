...
public class OffsetTimeTest {
    ...
    void create() {
        ...
        OffsetTime offsetTime2 = OffsetTime.now(ZoneId.of("Asia/Makassar"));
        OffsetTime offsetTime3 = OffsetTime.of(10, 10, 10, 10, ZoneOffset.ofHours(8));
        OffsetTime offsetTime4 = OffsetTime.parse("09:09:09.100+08:00");
        ...
        OffsetDateTime offsetDateTime2 = OffsetDateTime.now(ZoneId.of("Asia/Makassar"));
        OffsetDateTime offsetDateTime3 = OffsetDateTime.of(LocalDateTime.now(), ZoneOffset.ofHours(8));
