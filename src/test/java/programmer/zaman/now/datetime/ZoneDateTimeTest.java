...
public class ZoneDateTimeTest {
    ...
    void create() {
        ...
        ZonedDateTime zonedDateTime2 = ZonedDateTime.of(LocalDateTime.now(), ZoneId.of("Asia/Makassar"));
    ...
    @Test
    void parsing() {
        ZonedDateTime zonedDateTime1 = ZonedDateTime.parse("1980-10-10T10:10:10+08:00[Asia/Makassar]");
